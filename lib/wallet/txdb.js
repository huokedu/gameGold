...
class TXDB {
   ...
   * @returns {Boolean}
   */
  async resolveInput(tx, index, height, path, own) {
   ...
   * @returns {Promise}
   */
  async removeOutpointMap(hash, i) {
   ...
   * @returns {Promise}
   */
  async removeBlockMap(hash, height) {
   ...
   * @returns {Promise}
   */
  async removeBlockSlow(hash, height) {
   ...
   * @returns {Promise}
   */
  async verifyInput(tx, index, coin) {
   ...
   */
  getAccountHistoryHashes(account) {
  return this.keys({
   ...
   * @returns {Promise} - Returns {@link Hash}[].
   */
  getAccountPendingHashes(account) {
  return this.keys({
   ...
   * @returns {Promise} - Returns {@link Hash}[].
   */
  getAccountHeightRangeHashes(account, options) {
   ...
   * @returns {Promise} - Returns {@link Hash}[].
   */
  getHeightRangeHashes(account, options) {
   ...
   * @returns {Promise} - Returns {@link Hash}[].
   */
  getAccountRangeHashes(account, options) {
  const start = options.start || 0;
  const end = options.end || 0xffffffff;
   ...
   * @returns {Promise} - Returns {@link Hash}[].
   */
  getRangeHashes(account, options) {
  if (account && typeof account === 'object') {
    options = account;
    account = null;
  }
   ...
   */
  async getRange(account, options) {
  const txs = [];
   ...
   * @returns {Promise}
   */
  async updateSpentCoin(tx, index, height) {
